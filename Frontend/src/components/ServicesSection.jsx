    ...
    <section className='max-w-[350px] mx-auto sm:max-w-[550px] md:max-w-[1200px] mb-30 bg-[#CCF1F9] py-10 px-10 md:px-8 text-center shadow-xl rounded-xl'>
        ...
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
            <div>
                ...
                <p className='text-lg'>Masukkan data kesehatan dasar Anda dan dapatkan hasil prediksi yang akurat & tepat</p>
            </div>

            <div>
                <h3 className='text-xl font-bold mb-2'>Riwayat Pemeriksaan</h3>
                <p className='text-lg'>Lihat riwayat hasil prediksi Anda sebelumnya guna memantau kondisi dari waktu ke waktu</p>
            </div>

            <div>
                <h3 className='text-xl font-bold mb-2'>Edukasi Diabetes</h3>
                <p className='text-lg'>Temukan informasi seputar Penyakit Diabetes mulai dari gejala, penyebab, hingga tips pencegahan dan gaya hidup sehat</p>
            </div>
        </div>
    </section>
  )
