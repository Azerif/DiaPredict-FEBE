...
const ServicesSection = ({ id }) => {
  return (
    <section
      id={id}
      className="max-w-[350px] mx-auto intersect:motion-preset-slide-up motion-delay-400 sm:max-w-[550px] md:max-w-[1200px] mb-30 bg-[#CCF1F9] py-10 px-10 md:px-8 text-center shadow-xl rounded-xl"
    >
      <h2 className="text-4xl font-bold text-[#00B7E0] text-center mb-20">
        Layanan Kami
      </h2>
