...
const MitraSection = () => {
  return (
    <section className="max-w-[1200px] mx-auto mb-30 px-6 intersect:motion-preset-slide-up motion-delay-100">
      <div className="flex flex-row items-center justify-around sm:justify-around md:justify-around">
        <img
          src={Mitra1}
          alt="Mitra 1"
          className="w-full max-w-[95px] sm:max-w-[200px] md:max-w-[250px]"
        />
        <img
          src={Mitra2}
          alt="Mitra 2"
