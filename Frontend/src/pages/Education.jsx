  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main>        {/* Hero Section */}
        ...
        </section>        {/* Jenis Diabetes Section */}
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border-l-4 border-[#00B7E0]">
                  <div className="flex items-center mb-3">
                    <div className="bg-[#00B7E0] text-white rounded-full w-6 h-6 flex items-center justify-center font-bold mr-2 text-sm">
                      1
                    </div>
                    <h3 className="text-base font-semibold text-gray-800">Diabetes Tipe 1</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-sm">
                    Kondisi autoimun di mana sistem imun tubuh menyerang
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg border-l-4 border-green-500">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-base font-semibold text-gray-800">Diabetes Tipe 2</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-sm">
                    Tipe paling umum. Tubuh masih memproduksi insulin, tapi tidak
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-4 rounded-lg border-l-4 border-pink-500">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-base font-semibold text-gray-800">Diabetes Gestasional</h3>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-sm">
        ...
        </section>        {/* Gejala & Penyebab Section */}
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={index} className="flex items-center p-2 bg-red-50 rounded-lg">
                      ...
                      <span className="text-gray-800 font-medium text-sm">{gejala}</span>
                    </li>
                  ))}
                </ul>
              </div>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={index} className="flex items-center p-2 bg-orange-50 rounded-lg">
                      ...
                      <span className="text-gray-800 font-medium text-sm">{penyebab}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm max-w-xl mx-auto">
                  Diabetes dapat dicegah dengan menerapkan gaya hidup sehat. Berikut adalah langkah-langkah yang dapat Anda lakukan:
                </p>
              </div>
                ...
                {[
                  {
                    icon: "🥗",
                    title: "Makan Bergizi",
                    description: "Konsumsi makanan bergizi dan rendah gula secara teratur"
                  },
                  {
                    icon: "🏃‍♂️",
                  ...
                  },
                  {
                    ...
                    description: "Rutin memeriksa kadar gula darah secara berkala"
                  },
                  {
                    icon: "😌",
                    title: "Kelola Stres",
                    description: "Hindari stres berlebihan dengan relaksasi dan meditasi"
                  },
                  {
                    icon: "💤",
                    title: "Tidur Cukup",
                    description: "Pastikan tidur berkualitas 7-8 jam setiap malam"
                  }                ].map((item, index) => (
                  <div key={index} className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg border border-green-200 hover:shadow-md transition-shadow">
