  ...
  const handleChange = (e) => {
    ...
    if (files && files.length > 0) {
      ...
      if (!allowedFormats.includes(fileExtension)) {
        alertError(
          `Format file tidak didukung. Harap gunakan format: ${allowedFormats
            .join(", ")
            .toUpperCase()}`
        );
        e.target.value = "";
    ...
    try {
      ...
      if (form.password) {
        if (!form.currentPassword) {
          alertError(
            "Masukkan password saat ini untuk mengganti password baru"
          );
          return;
        }
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="text-center">
                        <svg
                          className="mx-auto h-6 w-6 text-[#00B7E0] group-hover:text-[#0092b3] mb-2"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
